    ...
    >
      <div className="relative z-20 w-full max-w-7xl flex flex-col md:flex-row gap-16 md:gap-48">
        ...
        <div className="w-full md:w-[40%] md:pt-20 md:mr-auto md:pl-16 text-left">
          ...
          <div className="contact-reveal mb-10">
            <p className="text-[10px] tracking-[0.2em] uppercase text-navy/40 mb-2">Τηλέφωνο</p>
          ...
          <div className="contact-reveal mb-10">
            <p className="text-[10px] tracking-[0.2em] uppercase text-navy/40 mb-2">Ώρες λειτουργίας</p>
            <p className="text-navy text-sm font-light leading-relaxed">
              Δευτέρα — Παρασκευή
              <br />
              09:00 — 18:00
          ...
          <div className="contact-reveal">
            <p className="text-navy/50 text-xs font-light leading-relaxed max-w-sm">
              Κάθε υπόθεση αντιμετωπίζεται με απόλυτη εχεμύθεια. Η πρώτη συνάντηση είναι χωρίς δέσμευση.
            </p>
          </div>
        </div>
      </div>
